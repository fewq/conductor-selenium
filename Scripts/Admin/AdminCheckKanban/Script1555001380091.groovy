...
WebUI.setText(findTestObject('Page_Sign In with Auth0/input_or_email'), 'admin@conductor.com')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Conductor Support Ticket/a_Kanban'), 5)

WebUI.click(findTestObject('Object Repository/Page_Conductor Support Ticket/a_Kanban'), FailureHandling.STOP_ON_FAILURE)
