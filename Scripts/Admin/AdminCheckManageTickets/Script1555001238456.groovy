...
WebUI.verifyElementPresent(findTestObject('Page_Conductor Support Ticket/a_Table View'), 5)

WebUI.click(findTestObject('Page_Conductor Support Ticket/a_Table View'), FailureHandling.STOP_ON_FAILURE)
